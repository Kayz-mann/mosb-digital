  ...
  if (req.method === "POST") {
    ...
    try {
      ...
      await transport.sendMail({
        ...
        //     content: Buffer.from(cvContent), // Convert ArrayBuffer to Buffer
        //     contentType: data.cv.type,
        //   },
        //   {
        //     filename: data.letter.name,
        //     content: Buffer.from(letterContent), // Convert ArrayBuffer to Buffer
        //     contentType: data.letter.type,
        //   },
        // ],
      });
